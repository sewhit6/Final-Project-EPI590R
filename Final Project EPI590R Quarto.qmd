...
@tbl-regression is a binomial logistic regression with squirrel age as the outcome and tail flags and tail twitches as predictors. For each tail flag that occurs, the odds of being an adult squirrel is 13% lower than the odds of being a juvenile (`r inline_text(table2, variable = "Tail flags")`, not statistically significant). For each tail twitch that occurs, the odds of being an adult squirrel is 20% lower than the odds of being a juvenile (`r inline_text(table2, variable = "Tail twitches")`, not statistically significant).
